...
__About launching on Windows:__ I don't know well how windows and R works. To use this app with `run_app`, you'll need to specify manually the path of the home. `backyard::run_app(home = "C://")` seems to do the trick (I'll spend some time to investigate on how to make it friendlier). 
