...
<ul>
<li>By default, `{backyard}` is deployed on port 2811. It can be changed in `backyard::run_app`.</li>
<li>If you launch the app in a Docker container, be sure to use `host = '0.0.0.0'`</li>
</ul>
